...
lerobot-train \
    ...
    --policy.repo_id=rgragulraj/act_mosaic_insert_star \
    ...
    --seed=1000 \
    --output_dir=/data/rrangasa/outputs/train/act_mosaic_insert_star \
    --job_name=act_mosaic_insert_star \
    --wandb.enable=false
